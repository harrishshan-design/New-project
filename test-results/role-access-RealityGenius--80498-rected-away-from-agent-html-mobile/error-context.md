...
- Name: role-access.spec.js >> RealityGenius role access >> guest is redirected away from /agent.html
...
Call log:
  - navigating to "https://realitygenius.company/agent.html", waiting until "load"
