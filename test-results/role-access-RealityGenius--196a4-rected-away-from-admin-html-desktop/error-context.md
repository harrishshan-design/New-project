...
- Name: role-access.spec.js >> RealityGenius role access >> guest is redirected away from /admin.html
- Location: tests\e2e\role-access.spec.js:11:5
...
Call log:
  - navigating to "https://realitygenius.company/admin.html", waiting until "load"
