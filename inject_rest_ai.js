...
function renderAIOrganizerView() {
    ...
    if(!aiProfile) {
        ...
        header.innerHTML = '<span style="font-weight:700; color:var(--brand-dark); text-transform:uppercase; font-size:0.8rem; letter-spacing:0.04em;">Your AI Match 🎯</span>' +
            ...
            '<p style="margin:6px 0 0; color: var(--muted); font-size: 0.95rem;">Because you are approaching this as an <strong>' + aiProfile.intent + '</strong> moving in <strong>' + aiProfile.timeline + '</strong>, I\\'ve curated these exact matches.</p>' +
...
console.log('Quiz AI system injected successfully!');
