...
function toggleSave(id, btn){
    ...
    renderProperties();renderCompare();popActiveControl();tapFeedback(added?"Saved to your vault":"Removed from saved homes",property?.title||"Property updated",added?"success":"alert");
}
